...
namespace ETModel {
  ...
  public partial class CommandInput : pb::IMessage {
    private static readonly pb::MessageParser<CommandInput> _parser = new pb::MessageParser<CommandInput>(() => (CommandInput)MessagePool.Instance.Fetch(typeof(CommandInput)));
  ...
  public partial class CommandResult : pb::IMessage {
    private static readonly pb::MessageParser<CommandResult> _parser = new pb::MessageParser<CommandResult>(() => (CommandResult)MessagePool.Instance.Fetch(typeof(CommandResult)));
  ...
  public partial class Command : pb::IMessage {
    private static readonly pb::MessageParser<Command> _parser = new pb::MessageParser<Command>(() => (Command)MessagePool.Instance.Fetch(typeof(Command)));
    ...
    private global::ETModel.CommandInput input_;
    public global::ETModel.CommandInput Input {
      get { return input_; }
      set {
        input_ = value;
      }
    ...
    private global::ETModel.CommandResult result_;
    public global::ETModel.CommandResult Result {
      get { return result_; }
      set {
        result_ = value;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      frame_ = 0;
      sequence_ = 0;
      if (input_ != null) MessagePool.Instance.Recycle(input_); input_ = null;
      if (result_ != null) MessagePool.Instance.Recycle(result_); result_ = null;
      uint tag;
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
          ...
          case 26: {
            if (input_ == null) {
              input_ = new global::ETModel.CommandInput();
            }
          ...
          case 34: {
            if (result_ == null) {
              result_ = new global::ETModel.CommandResult();
            }
  ...
  public partial class Actor_ClientCommond : pb::IMessage {
    private static readonly pb::MessageParser<Actor_ClientCommond> _parser = new pb::MessageParser<Actor_ClientCommond>(() => (Actor_ClientCommond)MessagePool.Instance.Fetch(typeof(Actor_ClientCommond)));
    public static pb::MessageParser<Actor_ClientCommond> Parser { get { return _parser; } }
    ...
    private static readonly pb::FieldCodec<global::ETModel.Command> _repeated_input_codec
        = pb::FieldCodec.ForMessage(10, global::ETModel.Command.Parser);
    private pbc::RepeatedField<global::ETModel.Command> input_ = new pbc::RepeatedField<global::ETModel.Command>();
    public pbc::RepeatedField<global::ETModel.Command> Input {
      get { return input_; }
      set { input_ = value; }
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      for (int i = 0; i < input_.Count; i++) { MessagePool.Instance.Recycle(input_[i]); }
      input_.Clear();
      rpcId_ = 0;
      actorId_ = 0;
      uint tag;
  ...
  public partial class Actor_ServerCommond : pb::IMessage {
    private static readonly pb::MessageParser<Actor_ServerCommond> _parser = new pb::MessageParser<Actor_ServerCommond>(() => (Actor_ServerCommond)MessagePool.Instance.Fetch(typeof(Actor_ServerCommond)));
    public static pb::MessageParser<Actor_ServerCommond> Parser { get { return _parser; } }
    ...
    private static readonly pb::FieldCodec<global::ETModel.Command> _repeated_result_codec
        = pb::FieldCodec.ForMessage(10, global::ETModel.Command.Parser);
    private pbc::RepeatedField<global::ETModel.Command> result_ = new pbc::RepeatedField<global::ETModel.Command>();
    public pbc::RepeatedField<global::ETModel.Command> Result {
      get { return result_; }
      set { result_ = value; }
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      for (int i = 0; i < result_.Count; i++) { MessagePool.Instance.Recycle(result_[i]); }
      result_.Clear();
      rpcId_ = 0;
      actorId_ = 0;
      uint tag;
  ...
  public partial class UnitStateInfo : pb::IMessage {
    private static readonly pb::MessageParser<UnitStateInfo> _parser = new pb::MessageParser<UnitStateInfo>(() => (UnitStateInfo)MessagePool.Instance.Fetch(typeof(UnitStateInfo)));
    public static pb::MessageParser<UnitStateInfo> Parser { get { return _parser; } }
  ...
  public partial class Actor_StateSync : pb::IMessage {
    private static readonly pb::MessageParser<Actor_StateSync> _parser = new pb::MessageParser<Actor_StateSync>(() => (Actor_StateSync)MessagePool.Instance.Fetch(typeof(Actor_StateSync)));
    public static pb::MessageParser<Actor_StateSync> Parser { get { return _parser; } }
    ...
    private static readonly pb::FieldCodec<global::ETModel.UnitStateInfo> _repeated_states_codec
        = pb::FieldCodec.ForMessage(10, global::ETModel.UnitStateInfo.Parser);
    private pbc::RepeatedField<global::ETModel.UnitStateInfo> states_ = new pbc::RepeatedField<global::ETModel.UnitStateInfo>();
    public pbc::RepeatedField<global::ETModel.UnitStateInfo> States {
      get { return states_; }
      set { states_ = value; }
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      for (int i = 0; i < states_.Count; i++) { MessagePool.Instance.Recycle(states_[i]); }
      states_.Clear();
      rpcId_ = 0;
      actorId_ = 0;
      uint tag;
