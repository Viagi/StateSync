...
namespace ETModel
{
	...
	[Message(OuterOpcode.CommandInput)]
	public partial class CommandInput {}

	[Message(OuterOpcode.CommandResult)]
	public partial class CommandResult {}

	[Message(OuterOpcode.Command)]
	public partial class Command {}

	[Message(OuterOpcode.Actor_ClientCommond)]
	public partial class Actor_ClientCommond : IActorLocationMessage {}

	[Message(OuterOpcode.Actor_ServerCommond)]
	public partial class Actor_ServerCommond : IActorMessage {}

	[Message(OuterOpcode.UnitStateInfo)]
	public partial class UnitStateInfo {}

	[Message(OuterOpcode.Actor_StateSync)]
	public partial class Actor_StateSync : IActorMessage {}
...
namespace ETModel
{
	public static partial class OuterOpcode
	{
		 ...
		 public const ushort CommandInput = 116;
		 public const ushort CommandResult = 117;
		 public const ushort Command = 118;
		 public const ushort Actor_ClientCommond = 119;
		 public const ushort Actor_ServerCommond = 120;
		 public const ushort UnitStateInfo = 121;
		 public const ushort Actor_StateSync = 122;
	}
}
